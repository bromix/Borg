...
namespace Borg
{
    ...
    {
        m_TotalMilliseconds = (m_Days * 24 * 60 * 60 + m_Hours * 60 * 60 + m_Minutes * 60 + m_Seconds) * 1000.0 + m_Milliseconds;
